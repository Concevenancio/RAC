<%@ Page Title="" Language="C#" MasterPageFile="~/VPA.Master" AutoEventWireup="true" CodeBehind="users_edit.aspx.cs" Inherits="WebApplication1.Views.Admin.users_edit" %>
                                    ...
                                    <form class="" action="" method="post" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="John f. Kennedy" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Placa<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
